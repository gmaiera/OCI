...
NOW
  ...
  -> Vibe Work
  -> DeepResearch / Cloud
  -> Idea Export Website / Idea Export PPT
...
1. Use `now` to decide the most important thing today.
...
5. Use `idea-export-website` or `idea-export-ppt` to package the idea for stakeholders.
