# Skill Eval: oracle-design-system

## Trigger Prompt

```text
Use oracle-design-system to review this internal dashboard and make it feel more Oracle Redwood-aligned.
```
...
```text
The answer creates a calm, decision-oriented deck structure with one message per slide and a clear final ask.
```

## Negative Prompt

```text
Make a playful consumer landing page with neon gradients.
```
