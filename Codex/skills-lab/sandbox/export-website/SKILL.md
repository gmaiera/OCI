---
name: export-website
description: "Create a shareable webpage to explain, package, or align people around information, proposals, or ideas. Use when the user wants to explore information or an idea, shape the message, build a website or landing page for stakeholders, personalize it from public or provided context, and end with a clear call to action."
---
...
Turn information, proposals, or ideas into a persuasive, shareable webpage with a clear audience, message, narrative, proof, and call to action. Prefer an online page or link when the user wants people to open, inspect, respond, share, comment, or revisit the information asynchronously.

This skill should make the message feel easier to say yes to: clear enough to scan, strong enough to discuss, and friendly enough to share.
...
5. Verify the page locally or through the chosen hosting path.
6. Provide the link or file path, summary, and CTA.
...
- Should the response path be email, form, calendar link, chat, GitHub issue, survey, or another channel?
...
6. Plan: next steps, responsibilities, timeline, or first-version path.
7. Risks and safeguards: acknowledge concerns and show mitigation.
8. CTA: ask for one concrete response or decision.

## Website Build Rules

- Build the actual webpage, not a page explaining the process.
- Keep the first viewport focused on the idea and decision.
...
- Before publishing publicly, confirm whether the content is confidential, internal-only, or safe to share.

## Verification

Before finalizing:

- Confirm the page loads locally or at the published URL.
- Confirm CSS and key assets load.
- Verify title, meta description, hero, CTA, footer, and response path.
